          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
               ...
               <button class="attach-file-btn">Attach Files (multiple selection enabled)</button>
                 <input type="file" id="file-upload" name="file_upload" class="btn btn-default btn-file"style="display: none;>
               </label>
              </div>
              <div class="form-group">
